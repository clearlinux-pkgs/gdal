...
Source0  : https://download.osgeo.org/gdal/3.1.0/gdal-3.1.0.tar.xz
...
%prep
%setup -q -n gdal-3.1.0
cd %{_builddir}/gdal-3.1.0
%patch1 -p1
pushd ..
cp -a gdal-3.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588968429
...
cp %{_builddir}/gdal-3.1.0/LICENSE.TXT %{buildroot}/usr/share/package-licenses/gdal/3c5056c99522acf3d9e2c2a2f61fdeeffced4174
cp %{_builddir}/gdal-3.1.0/alg/internal_libqhull/COPYING.txt %{buildroot}/usr/share/package-licenses/gdal/baf1d15dcf66b1e1dfee80eb405aa73105842017
cp %{_builddir}/gdal-3.1.0/doc/source/gdal_rtd/LICENSE %{buildroot}/usr/share/package-licenses/gdal/8ce271d47d282a4da574b385a8aff7a0d735188e
cp %{_builddir}/gdal-3.1.0/doc/source/license.rst %{buildroot}/usr/share/package-licenses/gdal/0f9d62383e84298877fe5f5d41f6a944f7ef8563
cp %{_builddir}/gdal-3.1.0/frmts/gif/giflib/COPYING %{buildroot}/usr/share/package-licenses/gdal/f9c9a2d3495a0766b4cf20d4b90cfe714dab3dc1
cp %{_builddir}/gdal-3.1.0/frmts/mrf/libLERC/LICENSE.TXT %{buildroot}/usr/share/package-licenses/gdal/3035b519169390d1aaa3a43267deaae5cdff8a9b
cp %{_builddir}/gdal-3.1.0/frmts/pcraster/libcsf/COPYING %{buildroot}/usr/share/package-licenses/gdal/1d982db70b88f943cc7d15013c28a126339d6cbc
cp %{_builddir}/gdal-3.1.0/frmts/png/libpng/LICENSE %{buildroot}/usr/share/package-licenses/gdal/fc3951ba26fe1914759f605696a1d23e3b41766f
cp %{_builddir}/gdal-3.1.0/ogr/ogrsf_frmts/flatgeobuf/LICENSE %{buildroot}/usr/share/package-licenses/gdal/161732baff9a38188301a521b567a20245367c7e
cp %{_builddir}/gdal-3.1.0/ogr/ogrsf_frmts/flatgeobuf/flatbuffers/LICENSE %{buildroot}/usr/share/package-licenses/gdal/abb8eb20f7f319cd8b292cdccce15826bac01363
cp %{_builddir}/gdal-3.1.0/ogr/ogrsf_frmts/geojson/libjson/COPYING %{buildroot}/usr/share/package-licenses/gdal/0cd23537e3c32497c7b87157b36f9d2eb5fca64b
cp %{_builddir}/gdal-3.1.0/ogr/ogrsf_frmts/shape/COPYING %{buildroot}/usr/share/package-licenses/gdal/df97bdf33b01f9ed42a799dd3ed7a1599dd0cb9d
cp %{_builddir}/gdal-3.1.0/port/LICENCE_minizip %{buildroot}/usr/share/package-licenses/gdal/f7f1d88d0aea6c567a2c351b08b0fe80f2582054
cp %{_builddir}/gdal-3.1.0/third_party/LercLib/LICENSE %{buildroot}/usr/share/package-licenses/gdal/3035b519169390d1aaa3a43267deaae5cdff8a9b
cp %{_builddir}/gdal-3.1.0/third_party/LercLib/NOTICE %{buildroot}/usr/share/package-licenses/gdal/4e8e03579f57bab9de5401be3fb96344f0823ead
pushd ../buildavx2/
%make_install_avx2
popd
%make_install
...
/usr/lib64/haswell/libgdal.so.27.0.0
/usr/lib64/libgdal.so.27
/usr/lib64/libgdal.so.27.0.0
