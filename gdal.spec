...
%setup -q -n gdal-3.9.2
cd %{_builddir}/gdal-3.9.2
%patch -P 1 -p1
pushd ..
cp -a gdal-3.9.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723818468
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgdal.so.35.3.9.2
/usr/lib64/libgdal.so.35
/usr/lib64/libgdal.so.35.3.9.2
